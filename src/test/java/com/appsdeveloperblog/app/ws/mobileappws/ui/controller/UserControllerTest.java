...
public class UserControllerTest {
	...
	final String USER_ID = "bklbjeaop3829";
	...
	final void testGetUser() {
		when(this.userService.getUserByUserId(anyString())).thenReturn(userDto);

		UserRest userRest = this.userController.getUser(USER_ID);
